...
if (isset($_POST["search"])) {
    ...
    header("Location: read_sales.php?id=".$_GET['id']);
    exit;
}
...
if (isset($_SESSION["search"])) {
    ...
    $sql = "SELECT od.id,od.quantity,p.autogenerated_code,p.description FROM sales_inventory od 
    inner join sales p on od.sales_id=p.id where od.inventory_header_id=:id 
    and (od.id LIKE $search or p.autogenerated_code LIKE $search or p.description LIKE $search)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute(array(':id' => $_GET['id']));
    $sales_inventorys = $stmt->fetchAll(PDO::FETCH_ASSOC);
} else {
    //$sql = "SELECT * FROM inventory_header LIMIT $start,$step";
    $stmt = $pdo->query("SELECT SalesOrderID, OrderDate, DueDate, TotalDue, Status 
    ...
    <div class="d-flex justify-content-center">
        <div class="table-responsive-xxl">
            <table class="table table-bordered" style="width: 1400px;">
                ...
                <thead>
                    <tr>
                        <th>SalesOrderID(ID de orden de venta)</th>
                        <th>OrderDate(Fecha de orden)</th>
                        <th>DueDate(Fecha de vencimiento)</th>
                        <th>TotalDue(Total adeudado)</th>
                        <th>Status(Estado)</th>
                        <th>Acciones</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $row['SalesOrderID']; ?></td>
                        ...
                        <div class='btn-group'>
                            <a class='btn btn-secondary py-0 disabled' href="update_sales.php?id=<?php echo $row['SalesOrderID']; ?>"><i class='fa-solid fa-pen-to-square'></i></a>
                            <a class='btn btn-danger py-0 disabled'href="delete_sales.php?id=<?php echo $row['SalesOrderID']; ?>"><i class='fa-solid fa-trash-can'></i></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination justify-content-center">
            ...
            if ($page == 1) {
                ...
                for ($i = 1; $i <= $x; $i++) {
                    if ($i === $page) {
                        echo "<li class='page-item active'><a class='page-link' href='read_sales.php?page=$i'>$i</a></li>";
                    } else {
                        echo "<li class='page-item'><a class='page-link' href='read_sales.php?page=$i'>$i</a></li>";
                    }
                }
                echo "<li class='page-item $disabled'><a class='page-link' href='read_sales.php?page=$next_page'>Siguiente</a></li>";
            } elseif ($page !== $number_pages) {
                echo "<li class='page-item'><a class='page-link' href='read_sales.php?page=$previous_page'>Anterior</a></li>";
                ...
                echo "<li class='page-item'><a class='page-link' href='read_sales.php?page=$next_page'>Siguiente</a></li>";
            } else {
                echo "<li class='page-item'><a class='page-link' href='read_sales.php?page=$previous_page'>Anterior</a></li>";
                if ($number_pages<=2) {
